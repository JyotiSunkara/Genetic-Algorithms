...
VECTOR_SIZE = 11
MATING_POOL_SIZE = 5
FILE_NAME_READ = 'JSON/jyoti.json'
FILE_NAME_WRITE = 'JSON/jyoti.json'
...
def mutation(child):
    ...
    if mutation_index == 1:
        ...
        vary = 1 + random.uniform(0.001, 0.004)
    
    elif mutation_index == 3:
        vary = 1 + random.uniform(-0.005, 0.005)
    
    elif mutation_index == 4:
        vary = 1 + random.uniform(0.009, 0.008)

    elif mutation_index == 5:
        vary = 1 + random.uniform(0.009, 0.001)
        ...
        vary = 1 + random.uniform(0.009, 0.009)
